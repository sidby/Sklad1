...
namespace SidBy.Sklad.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            ModelState.AddModelError("", ErrorStrings.UserNameOrPasswordIsIncorrect);
            return View(model);
        }
        ...
        public ActionResult Manage(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.ChangePasswordSuccess ? StatusMessageStrings.PasswordChanged
                : message == ManageMessageId.SetPasswordSuccess ? StatusMessageStrings.PasswordSet
                : message == ManageMessageId.RemoveLoginSuccess ? StatusMessageStrings.ExternalLoginWasRemoved
                : "";
        ...
        public ActionResult Manage(LocalPasswordModel model)
        {
            ...
            if (hasLocalAccount)
            {
                if (ModelState.IsValid)
                {
                    ...
                    {
                        ModelState.AddModelError("", ErrorStrings.CurrentPasswordIncorrectOrNewPasswordInvalid);
                    }
                }
            }
            else
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    {
                        ModelState.AddModelError("", String.Format(ErrorStrings.UnableToCreateLocalAccountMayAlreadyExist, User.Identity.Name));
                    }
                }
            }
        ...
        public ActionResult ExternalLoginConfirmation(RegisterExternalLoginModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                using (UsersContext db = new UsersContext())
                {
                    ...
                    {
                        ModelState.AddModelError("UserName", ErrorStrings.DuplicateUserName);
                    }
                }
            }
